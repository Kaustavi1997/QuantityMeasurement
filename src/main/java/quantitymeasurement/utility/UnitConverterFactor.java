...
public enum UnitConverterFactor {
    ...
    ,INCH_TO_FEET(0.083),INCH_TO_CM(2.5),CM_TO_INCH(.39),GALLON_TO_LITER(3.78),LITRE_TO_ML(1000)
    ,ML_TO_LITRE(.001),KG_TO_GR(1000),GR_TO_KG(.001),TONNE_TO_KG(1000),FR_TO_CE(0);
    public double value;
